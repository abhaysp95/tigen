...
namespace gen_algo {
	...
	data* data::get_instance() {
		...
		entities::room r1("R1", 55);
		entities::room r2("R2", 70);
		entities::room r3("R3", 60);
		entities::room r4("R4", 80);
		entities::room r5("R5", 50);
		...
		// courses running
		entities::course c1("C1", "Automobile", 12e3, std::vector<entities::instructor>{i3, i5});
		entities::course c2("C2", "Aeronautics", 5e3, std::vector<entities::instructor>{i5, i4});
		entities::course c3("C3", "Biological", 4e3, std::vector<entities::instructor>{i1, i7});
		entities::course c4("C4", "Chemical", 5e3, std::vector<entities::instructor>{i1, i7});
		entities::course c5("C5", "Embedded Programming", 2e3, std::vector<entities::instructor>{i2});
		entities::course c6("C6", "Web Development", 7e3, std::vector<entities::instructor>{i6, i9});
		entities::course c7("C7", "Networking Security", 4e3, std::vector<entities::instructor>{i2, i8});
	...
	std::vector<entities::class_time> data::get_class_time() const { return this->_class_times; }
};